...
def funds():
    ...
    for row in data.iterrows():
        fund = Fund(data.at[i, "Name"], data.at[i, "NAV"], data.at[i, "Dollar Change"], data.at[i, "Percent Change"], data.at[i, "1 year"], data.at[i, "3 year"],data.at[i, "5 year"], data.at[i, "10 year"], data.at[i, "Risk_Profile"])
        funds.append(fund)
        i += 1
    return funds
